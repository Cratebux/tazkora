...
const HomeFooter = () => {
  return (
    <footer className="flex w-full flex-col items-center gap-6 overflow-hidden border-t border-[#2A2B33] py-4 text-white lg:flex-row lg:justify-between lg:gap-0">
      <ul className="ml-10 flex w-full items-center justify-between text-sm lg:w-auto lg:justify-start lg:gap-6">
        <li>Tazkora.com</li>
        <li>Terms of Use</li>
      ...
      <div className="mr-10 flex w-full items-center justify-between lg:w-auto lg:justify-start lg:gap-6">
