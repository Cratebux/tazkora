  ...
  return (
    <header className="relative flex items-center justify-between px-6 py-8 lg:px-12">
      ...
      <ul className="hidden items-center gap-8 font-medium lg:flex">
        <li>
          <a href="#earn-section">Promote Brand</a>
        </li>
        <li>
      ...
      <motion.ul
        ...
        className="absolute left-0 right-0 top-20 flex h-auto flex-col items-center gap-8 overflow-hidden bg-black font-medium text-white lg:hidden"
      >
        <li>
