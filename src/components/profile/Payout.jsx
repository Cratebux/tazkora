  ...
  return (
    <div className="pb-10">
      ...
      <div className="pt-10">
        ...
        <input
          className="mt-2 lg:w-[370] w-full rounded bg-itembg p-3 lg:p-5 text-white opacity-40 outline-none"
        ...
        <div>
          <div className="flex w-full items-center rounded-lg bg-itembg p-3 lg:p-5 lg:w-[370]">
            <h1>Wema Bank - 025392660</h1>
          </div>

          <button className="mt-10 lg:w-[370] w-full rounded-lg bg-blue py-3 text-center text-white">
            WITHDRAW NOW
          </button>
        </div>
      </div>
