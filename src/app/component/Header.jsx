...
const Home = () => {
  return(
    <>
      ...
      <header className="lg:h-screen lg:bg-banner-bg  lg:px-10 pt-5 bg-cover object-fit bg-no-repeat">
          {/* start of header */}
          <div className="flex justify-between lg:pb-0 pb-5 px-5">
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="bg-backgroundDark lg:px-5 gap-2 py-3 rounded-full  w-max flex">
                    <Link href={'/'}>
                        <Image
                            src={notification}
                            width={20}
