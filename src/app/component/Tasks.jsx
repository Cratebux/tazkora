...
import filled from '../../../public/icons/filled.svg'
import { Search } from 'lucide-react'

const Tasks = () => {
  return (
    <div className='bg-backgroundDark lg:px-10 px-5 pt-20'>
        <div className='flex items-center justify-between '>
          ...
          <div className='lg:flex gap-5 hidden'>
            <div className='flex px-5 bg-background border py-2 rounded-md'>
                <input className='bg-backgroundDark outline-none text-white' placeholder='Search'/>
                <Search
                  color='white'
                />
            </div>
